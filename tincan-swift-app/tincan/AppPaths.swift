...
enum AppPaths {
    ...
    nonisolated static let tincanServerSetupTailscaleLogURL = logsDirectory.appendingPathComponent("tincan-server-setup-tailscale.log")
    ...
    nonisolated static let tincanServerSocketURL = runDirectory.appendingPathComponent("tincan-server.sock")
    nonisolated static let tincanServerTailscaleStatusURL = runDirectory.appendingPathComponent("tincan-server-tailscale-status.json")
